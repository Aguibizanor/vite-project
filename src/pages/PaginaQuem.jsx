...
<main className="main">
 ...
 <div className="container3">
    ...
    width: '80%', // Ajuste conforme necessário para o tamanho dos seus quadrados
    padding: '20px', // Espaço ao redor dos quadrados
    backgroundColor: 'rgba(255, 255, 255, 0.8)', // Um fundo para destacar os quadrados, opcional
  }}>
          <h2>QUEM SOMOS?</h2>
